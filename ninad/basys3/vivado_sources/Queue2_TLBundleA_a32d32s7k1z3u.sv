...
module Queue2_TLBundleA_a32d32s7k1z3u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_2x84 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data, io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[51:48];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[83:52];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
